         ...
         <div className="container mt-5">
            ...
            <div className="p-4 p-md-5 mb-4 rounded text-body-emphasis bg-body-secondary">
                  <div className="col-lg-6 px-0">
                     ...
                     <p className="lead mb-0"><Link to="/about" className="text-body-emphasis fw-bold">Continue reading...</Link></p>
                  </div>
               </div>
               <div className="row mb-2">
                  <div className="col-md-6">
                     ...
                     <div className="col p-4 d-flex flex-column position-static">
                        ...
                        <a to="#" className="icon-link gap-1 icon-link-hover stretched-link">
                           Continue reading
                           <svg className="bi"><use to="#chevron-right"></use></svg>
                        </a>
                     </div>
